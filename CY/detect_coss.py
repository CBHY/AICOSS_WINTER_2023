...
def detect(opt):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                # Rescale boxes from img_size to im0 size --> 이걸 하면 안됨!
                ...
                for det_index, (*xyxy, conf, cls) in enumerate(reversed(det[:,:6])):
                    ...
                    if save_txt:  # Write to file
                        ...
                        f_bb = line
                        f_bblist.append(f_bb)
                        #print(f_bblist) : bounding box 변수로 받아서 list형태로 저장
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/images/11.jpg', help='source')  # file/folder, 0 for webcam
